...
<Figure src={require('./figs/vla/pi0_fast_teaser.webp').default} caption="π₀-FAST 原文总览：FAST 将高频动作块 token 化后接入自回归 VLA；右侧展示不同控制频率下 FAST 与 OpenVLA-style tokenization 的差异" width={820} />
...
<Figure src={require('./figs/vla/pi0_fast_dct_method.webp').default} caption="FAST tokenizer 原文流程：连续 action chunk 先经 DCT 转到频域，再量化、展平，并通过 BPE 压缩成离散 action tokens" width={900} />
