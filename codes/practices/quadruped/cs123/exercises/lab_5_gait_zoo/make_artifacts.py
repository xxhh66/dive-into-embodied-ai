...
def main() -> None:
    ...
    gait_zoo_gif = PORTFOLIO_DIR / "gait_zoo.gif"
    gait_gantts_png = PORTFOLIO_DIR / "gait_gantts.png"
    gif_utils.write_gif(
        frames,
        gait_zoo_gif,
        fps=GIF_FPS,
    ...
    gif_size_mb = gait_zoo_gif.stat().st_size / (1024 * 1024)
    print(f"Lab 5 观察图已写入 {PORTFOLIO_DIR}/")
    print(f"已写出 gait_zoo.gif / gait_gantts.png / base_z_fft.png，GIF={gif_size_mb:.2f} MB")
